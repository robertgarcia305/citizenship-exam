const questions = [
    ...
    },
    {
        ...
        answer: ["Answers will vary. [Residents of territories with nonvoting Delegates or Resident Commissioners may provide the name of that Delegate or Commissioner.]"]
    },
    {
        id: 24,
    ...
    }, 
    {
        ...
        answer: ["Cherokee", "Navajo", "Sioux", "Chippewa", "Choctaw", "Pueblo", "Apache", "Iroquois"]
    }, 
    {
        id: 88,
...
function showAnswer() {
    const answerElement = document.getElementById("answer");
    const currentAnswer = shuffledQuestions[currentIndex].answer;
